...
class MultiModalDataset(Dataset):
    ...
    def __init__(self, input_files, tokenizer, processor, max_length=2048,
    ...
    def __getitem__(self, index):
        ...
        task_type = data.get('task_name', 'dummy_default').split('_')[-1] # Get processor type
        while True:
            try:
                ...
                data = self.dataset[index]
                task_type = data.get('task_name', 'dummy_default').split('_')[-1]
                traceback.print_exc()
                ic()
                continue
            break
