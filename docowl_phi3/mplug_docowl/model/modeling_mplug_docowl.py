...
from transformers import AutoConfig, AutoModelForCausalLM, PhiModel, PhiForCausalLM
...
class MPLUGDocOwlPhiModel(MPLUGDocOwlMetaModel, PhiModel):
    config_class = MPLUGDocOwlConfig

    def __init__(self, config: MPLUGDocOwlConfig):
        super(MPLUGDocOwlPhiModel, self).__init__(config)


class MPLUGDocOwlLlamaForCausalLM(PhiForCausalLM, MPLUGDocOwlMetaForCausalLM):
    config_class = MPLUGDocOwlConfig

    def __init__(self, config):
        super(PhiForCausalLM, self).__init__(config)
        self.model = MPLUGDocOwlPhiModel(config)
